...
class Command(BaseCommand):
    ...
    def _difficult1(self):
        ...
        new_word_set = WordSet(name="difficult1 (for advanced and native speakers)", description="difficult characters")
        new_word_set.save()
    ...
    def _difficult2(self):
        ...
        new_word_set = WordSet(name="difficult2 (for advanced and native speakers)", description="difficult characters")
        new_word_set.save()
        with open(dataset, 'rb') as fin:
            rank = 0
            reader = UnicodeReader(fin)
    ...
    def _least_common(self):
        ...
        new_word_set = WordSet(name="intermediate", description="last 10 characters")
        new_word_set.save()
        with open(dataset, 'rb') as fin:
            rank = 0
            reader = UnicodeReader(fin)
